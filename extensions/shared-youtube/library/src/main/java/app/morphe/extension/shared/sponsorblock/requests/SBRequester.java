...
public class SBRequester {
    ...
    public static SponsorSegment[] getSegments(String videoId) {
        ...
        try {
            ...
            handleConnectionError(str("morphe_sb_sponsorblock_connection_failure_timeout"), ex);
        } catch (IOException ex) {
            handleConnectionError(str("morphe_sb_sponsorblock_connection_failure_generic"), ex);
        } catch (Exception ex) {
            // Should never happen
    ...
    public static void submitSegments(String videoId, SegmentCategory category, SegmentSubmitAction action,
        ...
        try {
            ...
            Utils.showToastLong(str("morphe_sb_submit_failed_unknown_error", 0, ex.getMessage()));
        } catch (Exception ex) {
            ...
            try {
                ...
                switch (responseCode) {
                    ...
                    case 403:
                        ...
                        break;
                    default:
                        userMessage = str("morphe_sb_vote_failed_unknown_error",
                                responseCode, connection.getResponseMessage());
                        break;
                }
                ...
                Utils.showToastShort(str("morphe_sb_vote_failed_unknown_error", 0, ex.getMessage()));
            } catch (Exception ex) {
    ...
    public static String setUsername(String username) {
        ...
        try {
            ...
            return str("morphe_sb_stats_username_change_unknown_error", 0, ex.getMessage());
        }
    }
